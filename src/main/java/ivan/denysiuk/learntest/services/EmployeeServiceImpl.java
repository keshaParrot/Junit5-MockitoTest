...
public class EmployeeServiceImpl implements EmployeeService {
     ...
     */
    @Override
    public List<Employee> findByParams(String pesel, String fullName, String specialization) {
        return employeeRepository.findByParams(pesel, fullName, specialization);
    }
    /**
